...
class YummyModelTest(unittest.TestCase):
    ...
    def test_yummylist_is_added_to_yummylists_dictionary_and_can_be_deleted(self): # test ensures that bucketlist is added
    ...
    def test_return_false_if_yummylist_to_be_added_is_empty(self):
        self.assertEqual(False, self.user.create_user_DB(''))
    #
    def test_return_false_if_yummylist_to_be_added_exists(self):
        self.assertEqual(False, self.user.create_user_DB('dengima'))

    def test_delete_non_existent_yummylist(self):
        models.logged_in = ['dengima@gmail.com']
